...
# set random seed
np.random.seed(123)
with open('../exports/LBC/LBC_syn_cohort_1_qc.pk', 'rb') as f:
    participant_syn = pk.load(f)

with open('../exports/LBC/LBC_non_syn_cohort_1_qc.pk', 'rb') as f:
...
plt.savefig('../exports/LBC/cohort_1/BF_plot.png')
plt.savefig('../exports/LBC/cohort_1/BF_plot.svg')
# %%
...
with open('../exports/LBC/cohort_1/LBC_cohort_1_ns_LiFT_updated.pk', 'wb') as f:
    pk.dump(participant_ns, f)
   
with open('../exports/LBC/cohort_1/LBC_cohort_1_syn_LiFT_updated.pk', 'wb') as f:
...
LBC_cohort = [part[part.obs.LiFT_value>1] for part in participant_ns]
LBC_cohort = [part for part in LBC_cohort if part.shape[0]>0]
len(LBC_cohort)
sum([part.shape[0] for part in LBC_cohort])
sum([part.shape[1] for part in LBC_cohort])
