...
def bayesian_model_comparison(data, ext_priors_dict=False, hidden=True,
                              binomial=True, bayes_factor_threshold=4):

    # Load external priors
    if ext_priors_dict is not False:
        binom_p_prior = ext_priors['binom_p_prior']
        betabinom_p_prior = ext_priors['betabinom_p_prior']
        betabinom_beta_prior = ext_priors['betabinom_beta_prior']
    ...
    data = binom_artifact_model_probability(data, prior_p=binom_p_prior)
